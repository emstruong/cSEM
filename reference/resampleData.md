...
#>   ..$ imag1: int [1:250] 7 4 10 5 9 7 9 8 9 8 ...
#>   ..$ imag2: int [1:250] 7 1 8 8 9 7 9 10 9 7 ...
#>   ..$ imag3: int [1:250] 8 4 8 8 9 7 6 10 9 8 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 9 8 9 8 10 5 9 9 8 10 ...
#>   ..$ imag2: int [1:250] 9 8 9 8 10 5 9 10 10 10 ...
#>   ..$ imag3: int [1:250] 10 8 9 9 10 7 9 10 8 10 ...
#>   .. [list output truncated]
#>  $ :'data.frame':    250 obs. of  27 variables:
#>   ..$ imag1: int [1:250] 5 10 10 6 7 10 7 9 7 7 ...
#>   ..$ imag2: int [1:250] 3 10 10 7 8 10 7 9 5 7 ...
#>   ..$ imag3: int [1:250] 4 10 10 7 9 10 7 9 7 7 ...
#>   .. [list output truncated]
#>   [list output truncated]
...
#>   .. ..$ x1   : num [1:10] 0.664 -0.468 0.441 -0.261 0.152 ...
#>   .. ..$ x2   : num [1:10] -0.113 -0.536 0.972 0.286 -0.284 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.229 0.854 -0.901 -0.242 -0.766 ...
#>   .. ..$ x2   : num [1:10] -1.178 -0.99 -0.405 0.667 -0.386 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "female" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.603 -0.242 0.412 1.292 0.852 ...
#>   .. ..$ x2   : num [1:10] 0.4491 1.0664 -0.0186 -0.8047 -0.9473 ...
#>   .. ..$ group: chr [1:10] "female" "female" "male" "female" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -1.093 -0.901 -0.628 -0.084 -0.714 ...
#>   .. ..$ x2   : num [1:10] 0.892 -0.405 0.736 -0.708 0.74 ...
#>   .. ..$ group: chr [1:10] "female" "male" "male" "female" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.735 -1.261 -0.266 0.419 -0.752 ...
#>   .. ..$ x2   : num [1:10] -0.331 -1.649 0.322 0.212 0.463 ...
#>   .. ..$ group: chr [1:10] "female" "male" "female" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 1.292 0.603 0.184 1.117 0.903 ...
#>   .. ..$ x2   : num [1:10] -0.805 0.449 2.375 -1.152 2.454 ...
#>   .. ..$ group: chr [1:10] "female" "female" "female" "male" ...
#>   .. [list output truncated]
#>  $ :List of 10
#>   ..$ 1 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.634 -0.768 -1.428 -0.319 0.452 ...
#>   .. ..$ x2   : num [1:10] 0.97031 -2.10225 -0.2837 -0.50119 -0.00514 ...
#>   .. ..$ group: chr [1:10] "male" "female" "male" "male" ...
#>   ..$ 2 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] 0.206 1.377 -0.977 0.596 1.871 ...
#>   .. ..$ x2   : num [1:10] 1.901 1.092 0.693 0.549 -1.049 ...
#>   .. ..$ group: chr [1:10] "male" "male" "male" "male" ...
#>   ..$ 3 :'data.frame':   10 obs. of  3 variables:
#>   .. ..$ x1   : num [1:10] -0.279 1.177 -0.766 -0.375 1.292 ...
#>   .. ..$ x2   : num [1:10] 2.196 0.529 -0.386 -0.868 -0.805 ...
...
#> Warning: data length is not a multiple of split variable
#> Warning: data length is not a multiple of split variable
#> Warning: UNRELIABLE VALUE: One of the ‘future.apply’ iterations (‘future_lapply-1’) unexpectedly generated random numbers without declaring so. There is a risk that those random numbers are not statistically sound and the overall results might be invalid. To fix this, specify 'future.seed=TRUE'. This ensures that proper, parallel-safe random numbers are produced via a parallel RNG method. To disable this check, use 'future.seed = NULL', or set option 'future.rng.onMisuse' to "ignore". [future ‘future_lapply-1’ (30711487e0e0a728ac496fdfeb46f3df-15); on 30711487e0e0a728ac496fdfeb46f3df@runnervmeorf1<7375>]
